...
/**
 * SQLite3 PDO Database Adapter Class by Xintrea v.0.01
 *
 ...
 */
class CI_DB_sqlite3pdo_driver extends CI_DB {

	var $dbdriver = 'sqlite3pdo';
	...
	function db_pconnect()
	{
		...
		return $this->db_connect(); // SQLite3 can't support persistent connection
	}
